        ...
        while len(brains) != 1 :
            ...
            for b in range(len(brains)) :
                ...
                if not net.trained :
                    ...
                    self.Homemade(net, sample, solution, activation_sup=activation_sup, loss_function=loss_function, learning_rate=learning_rate, n_batch=n_batch, n_step=n_step, debug=debug)
